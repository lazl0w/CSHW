...
FILE *pfileInventory; // stream input for the inventory information
...
{
  char *pszOrderFileName = NULL;      //  pointer to the customer order file 
  char *pszInventoryFileName = NULL;  // pointer to the inventory file
  ...
  /* First we need to read the inventory input file and assign the values into the array of stock, then we need
      print the inventory information before the orders have been processed. */

  //  open the Inventory File, stream the data
